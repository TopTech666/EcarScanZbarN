package com.ecar.ecarscanzbarn;
...
import com.ecar.ecarzbar.CameraManager;
import com.ecar.ecarzbar.CameraPreview;
...
//			Image barcode = new Imahge(size.width, size.height, "Y800");
...
//			}
			...
			String resultStr = zBarDecoder.decodeCrop(rotatedData, size.width, size.height, mCropRect.left, mCropRect.top, mCropRect.width(), mCropRect.height());
